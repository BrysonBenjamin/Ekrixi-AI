...
export const getCategoryColor = (cat: any, reified?: boolean) => {
    ...
    switch (cat) {
        ...
        case NexusCategory.STORY: return '#e11d48'; 
...
export const getCategoryIconSvg = (cat: any, color: string, reified?: boolean) => {
    ...
    if (reified) {
        ...
        switch (cat) {
            ...
            case NexusCategory.STORY: path = '<path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1 0-5H20"/><circle cx="12" cy="8" r="2"/>'; break;
