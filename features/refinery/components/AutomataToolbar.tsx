...
export const AutomataToolbar: React.FC<AutomataToolbarProps> = ({ selectedObject, onAction, onClose }) => {
    return (
        <aside className="w-full h-full md:w-64 border-l border-nexus-800 bg-nexus-900 flex flex-col shrink-0">
            ...
            <div className="px-4 py-8 mt-4 border-y border-nexus-800/50 bg-black/20">
                 <div className="text-[9px] font-bold text-slate-700 uppercase tracking-widest text-center mb-4">Nexus Stability Index</div>
                ...
                <div className="mt-auto border-t border-nexus-800 p-4 bg-nexus-950/40">
                     ...
                     <div className="space-y-2">
                         ...
                         <div className="flex justify-between text-[9px] font-mono">
                             ...
                             <span className="text-nexus-500">{(selectedObject as any).total_subtree_mass || 0}</span>
                         </div>
                         <div className="flex justify-between text-[9px] font-mono">
...
const AutomataButton = ({ icon: Icon, title, desc, onClick }: any) => (
    ...
    >
        ...
        <div className="flex-1 min-w-0">
            <div className="text-[11px] font-bold text-white uppercase tracking-wider mb-0.5">{title}</div>
