...
export const getRefineryDemoBatch = (): NexusObject[] => {
    ...
    return [
        ...
        // 2. Mid-level Container: The City
        {
            ...
            prose_content: "Built on the highest peak of the central cluster, Lux Aeterna is the seat of the Solar Council.",
            category_id: NexusCategory.LOCATION,
            is_ghost: false,
            internal_weight: 0.9,
        ...
        // 4. Atomic Node: Protagonist
        {
            ...
            prose_content: "Elara lost her license after the *Kessel Incident*. Now she flies for whoever has the most Aether-Quartz.",
        ...
        // 5. Atomic Node: Rival
        {
            ...
            prose_content: "Krell is obsessed with order. He views Elara as a chaotic variable that needs to be removed from the equation.",
            category_id: NexusCategory.CHARACTER,
            is_ghost: false,
        ...
        // 7. Item Note
        {
            ...
            prose_content: "Dangerous to handle without lead-lined gloves. It hums at a frequency that induces migraines in non-mages.",
