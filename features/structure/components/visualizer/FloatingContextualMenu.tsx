    ...
    return (
        <div className="fixed inset-0 z-[400] pointer-events-none overflow-hidden">
            ...
            >
                ...
                <div className={`absolute w-3 h-3 rounded-full ${reified ? 'bg-nexus-accent shadow-[0_0_15px_var(--accent-color)]' : 'bg-nexus-text shadow-[0_0_10px_var(--text-main)]'}`} />
                ...
                {actions.map((action, i) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            >
                                <div className={`w-14 h-14 rounded-full bg-nexus-900 border border-nexus-800 flex items-center justify-center shadow-2xl group-active:scale-90 group-active:bg-nexus-800 transition-all ring-2 ring-transparent group-hover:ring-nexus-accent/20`}>
