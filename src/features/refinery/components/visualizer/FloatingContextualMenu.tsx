  ...
  return (
    <div className="fixed inset-0 z-[400] pointer-events-none overflow-hidden">
      ...
      >
        ...
        <div
          className={`absolute w-2 h-2 rounded-full ${reified ? 'bg-orange-500 shadow-[0_0_10px_#f97316]' : 'bg-nexus-accent shadow-[0_0_10px_#06b6d4]'}`}
        />
        ...
        {actions.map((action, i) => {
          ...
          return (
            ...
            >
              ...
              >
                <div
                  className={`w-12 h-12 rounded-full bg-nexus-900 border ${reified ? 'border-orange-500/30' : 'border-nexus-800'} flex items-center justify-center shadow-2xl group-active:scale-90 group-active:bg-nexus-800 transition-all`}
                >
