...
export const WikiHeader: React.FC<WikiHeaderProps> = ({
  ...
  return (
    <div className="flex items-center justify-between mb-16 sticky top-4 z-50 pointer-events-none gap-4">
      <div className="flex bg-nexus-900/90 backdrop-blur-xl border border-nexus-700/50 rounded-full p-1.5 shadow-2xl pointer-events-auto items-center gap-2">
        <button
          onClick={onBack}
          className="p-2.5 rounded-full text-nexus-muted hover:text-nexus-text hover:bg-nexus-800/40 transition-all group"
        ...
        <button
          ...
          className="p-2.5 rounded-full text-nexus-muted hover:text-nexus-text hover:bg-nexus-800/40 transition-all"
              ...
              <div>
                ...
                <div className="flex flex-col gap-3">
                  ...
                  {(currentObject as SimpleNote).background_url && (
                    <button
                      onClick={() =>
                        onUpdateObject(currentObject.id, { background_url: undefined })
                      }
