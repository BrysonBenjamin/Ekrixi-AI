    ...
    <>
      <div className="absolute top-6 left-6 z-10 pointer-events-none">
        <div className="flex items-center gap-2 mb-1">
          ...
          <span className="text-[10px] font-display font-black text-nexus-text uppercase tracking-[0.3em]">
            H-Tree Visualizer
          </span>
        </div>
        <div className="text-[9px] text-nexus-muted font-mono uppercase tracking-widest opacity-60">
          Neural Infrastructure // {nodeCount} Nodes Active
        </div>
      </div>
      ...
      <div className="absolute bottom-8 left-8 z-10 flex flex-col gap-3">
        <div className="flex bg-nexus-900/80 backdrop-blur-xl border border-nexus-800 rounded-2xl p-1.5 shadow-2xl pointer-events-auto">
          <button
            onClick={onResetZoom}
            className="p-2.5 rounded-xl hover:bg-nexus-800 text-nexus-muted hover:text-nexus-text transition-all"
            title="Reset Camera"
          >
            <Target size={20} />
          </button>
        ...
        <div className="bg-nexus-900/40 backdrop-blur-md px-4 py-2 rounded-xl border border-nexus-800 flex items-center gap-3">
          ...
          <span className="text-[9px] font-mono text-nexus-muted font-bold uppercase tracking-[0.2em]">
            Logic Kernel: Validated
          </span>
        </div>
      </div>
    </>
