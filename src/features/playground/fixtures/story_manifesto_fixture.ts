  ...
  return [
    {
      ...
      type: 'THESIS',
      data: {
        text: 'In a world where memories are traded as currency, a disgraced archivist discovers a memory that could crash the global economy.',
      },
    },
    {
      id: generateId(),
      ...
      data: {
        archetype: 'SAVE_CAT',
        rationale:
          'We need clear pacing beats to manage the complex world-building of the memory economy.',
      },
    },
    {
      id: generateId(),
    ...
    },
    {
      ...
      type: 'ORACLE_PROMPT',
      data: {
        text: "Ensure the 'Save the Cat' beats focus on the internal guilt of the archivist.",
      },
    },
  ];
};
