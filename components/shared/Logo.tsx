...
export const Logo: React.FC<LogoProps> = ({ className = "w-10 h-10", size = 40 }) => {
    ...
    const renderSvgLogo = () => (
        ...
        >
            ...
            {/* Background Core */}
            <circle cx="50" cy="50" r="45" fill="var(--bg-900)" stroke="url(#ekrixi-gradient)" strokeWidth="2" />
            ...
            {/* Inner Accents */}
            <path d="M50 30L52 48L70 50L52 52L50 70L48 52L30 50L48 48Z" fill="white" opacity="0.8" />
            
            {/* Orbitals */}
            <circle cx="50" cy="50" r="32" stroke="var(--accent-color)" strokeWidth="0.5" strokeDasharray="4 4" opacity="0.3" />
        </svg>
    );
